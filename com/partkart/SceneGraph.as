package com.partkart{
	...
	public class SceneGraph extends Sprite{
		...
		public function editprofile(flist:Array):void{
			...
			if(cut.tooldiameter != tooldiameter || cut.outside != outside){
				redrawcut = true;
			}
		...
		public function editpocket(flist:Array):void{
			...
			var redrawcut:Boolean = false;
			if(tooldiameter != cut.tooldiameter || roughingclearance != cut.roughingclearance || stepover != cut.stepover){
				redrawcut = true;
			}
		...
		public function reprocessCuts(pd:ProgressDialog, cut:CutObject=null):void{
			progressdialog = pd;
