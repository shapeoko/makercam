package com.partkart{
	...
	public class Nest extends GreenThread{
		...
		private function place():Object{
			...
			if((region.width*scale > blankbitmap.width && region.height*scale > blankbitmap.height) || (region.width*scale > blankbitmap.height && region.height*scale > blankbitmap.width)){
				return null;
			}
